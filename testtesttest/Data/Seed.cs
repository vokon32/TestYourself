    ...
    public class Seed
    {
        public static void SeedData(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                var math = context.Tests.FirstOrDefault(t => t.TestCategory == Enum.TestCategory.Math).Id;
                var literature = context.Tests.FirstOrDefault(t => t.TestCategory == Enum.TestCategory.Literature).Id;
                var english = context.Tests.FirstOrDefault(t => t.TestCategory == Enum.TestCategory.English).Id;
